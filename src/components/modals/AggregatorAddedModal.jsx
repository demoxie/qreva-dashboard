    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg w-full max-w-md p-8 relative">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-2xl font-semibold text-[#1E1E1E] mb-3">Aggregator added</h2>
          <p className="text-gray-600 mb-8 max-w-sm">
            This aggregator has been sent an invitation link to the email just registered and can go ahead to onboard on the app!
          </p>
