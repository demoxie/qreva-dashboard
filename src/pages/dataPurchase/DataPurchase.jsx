...
import { createCustomerTransactionActions } from './constants';
      ...
      <div className="flex-1 overflow-auto bg-[#F7FAFA]">
        <div className="p-6 flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="text-gray-600">Loading data purchase metrics...</p>
          </div>
        </div>
      </div>
    );
  ...
  if (isError || !metrics) {
    return (
      <div className="flex-1 overflow-auto bg-[#F7FAFA]">
        <div className="p-6 flex items-center justify-center min-h-screen">
          <div className="text-center">
            <p className="text-red-600 mb-4">Failed to load data purchase metrics</p>
            <button
              onClick={() => refetch()}
  ...
  return (
    <div className="flex-1 overflow-auto bg-[#F7FAFA]">
      <div className="p-6">
        ...
        <DashboardStats stats={formattedStats} route="data-purchase" />
